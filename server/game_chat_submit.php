...
// Get information from frontend, insert chat message associated with a game ID, redirect user back to game with the ID.
if(login_check($pdo) == true && checkCSRFToken($_POST['token'])){
